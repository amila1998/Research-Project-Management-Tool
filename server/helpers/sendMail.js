...
const sendEmailtoSupervisorReq = (to,group_id) => {
  oauth2client.setCredentials({
    refresh_token: G_REFRESH_TOKEN,
  });
  const accessToken = oauth2client.getAccessToken();
  ...
  <body>
    <div class="container">
      <div class="wrapper">
        <div class="card">
         <h1>You have new Request from group id:  ${group_id}</h1>
        </div>
      </div>
    </div>
  </body>
...
const sendEmailtoCoSupervisorReq = (to,group_id) => {
  oauth2client.setCredentials({
    refresh_token: G_REFRESH_TOKEN,
  });
  const accessToken = oauth2client.getAccessToken();
...
const sendEmailtoPanalMemforAddEve = (to) => {
  ...
  const mailOptions = {
    from: ADMIN_EMAIL,
    to: to,
    subject: "ADDED AS A TOPIC EVALUVATION PANAL MEMBER",
    html: `
  <html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="container">
      <div class="wrapper">
        <div class="card">
         <h1>Your are added to the Topic Evaluvation Panal</h1>
        </div>
      </div>
    </div>
  </body>
...
const sendEmailtoGroupStudents = (to,text,subject) => {
  oauth2client.setCredentials({
    refresh_token: G_REFRESH_TOKEN,
  });
  const accessToken = oauth2client.getAccessToken();
...
module.exports = { sendEmailRegister, sendEmailReset, sendEmailtoCoSupervisorReq, sendEmailtoSupervisorReq, sendEmailtoPanalMemforAddEve,sendEmailtoGroupStudents};